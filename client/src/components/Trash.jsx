...
function Trash() {
    ...
    const fetchFiles = axios
      ...
      .then((res) => {
        if (Array.isArray(res.data)) {
          ...
          console.error("Expected an array of files, got");
        }
      })
      .catch((error) => console.error("Error fetching files"));
    ...
    const fetchFolders = axios
      ...
      .then((res) => {
        if (Array.isArray(res.data)) {
          ...
          console.error("Expected an array of folders, got");
        }
      })
      .catch((error) => console.error("Error fetching folders"));
  ...
  const handleFileRestore = (fileId) => {
    axios
      ...
      .catch((error) => console.error("Error restoring file"));
  };
  ...
  const handleFolderRestore = (folderId) => {
    axios
      ...
      .catch((error) => console.error("Error restoring folder"));
  };
